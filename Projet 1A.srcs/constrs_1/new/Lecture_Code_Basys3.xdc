...
##Pmod Header JB
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports {Digit[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Digit[3]}]
###Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports {Digit[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Digit[2]}]
###Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {Digit[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Digit[1]}]
###Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports {Digit[0]}]					
...
##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {S_EN}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S_EN}]
##Sch name = JC2
